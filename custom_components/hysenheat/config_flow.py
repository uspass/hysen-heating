"""
Configuration flow for Hysen Heating Controller.
...
class HysenHeatingConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Hysen Heating Controller.
    ...
    def async_get_options_flow(config_entry):
        ...
        Returns:
            HysenHeatingOptionsFlowHandler: The options flow handler instance.
        """
        return HysenHeatingOptionsFlowHandler(config_entry)

class HysenHeatingOptionsFlowHandler(config_entries.OptionsFlow):
